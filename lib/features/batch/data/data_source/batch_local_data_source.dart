...
final batchLocalDataSourceProvider=Provider.autoDispose<BatchLocalDataSource>((ref) => BatchLocalDataSource(
...
class BatchLocalDataSource {
  ...
  Future<Either<Failure, List<BatchEntity>>> getAllBatches() async {
    try{
     ...
     List<BatchEntity>batchEntities=batches.map((e) => BatchHiveModel.toEntity(e)).toList();
